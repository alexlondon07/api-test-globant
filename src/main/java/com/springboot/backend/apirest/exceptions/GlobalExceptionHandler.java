...
import com.springboot.backend.apirest.web.ApiError;
import com.springboot.backend.apirest.web.ResponseEntityBuilder;
...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
	...
	// handleConstraintViolationException : triggers when @Validated failsCodigo ya existe
	...
	@ExceptionHandler(CodeNumberViolationException.class)
	public ResponseEntity<?> CodeNumberViolationException(Exception ex, WebRequest request) {
		
		List<String> details = new ArrayList<String>();
		details.add(ex.getMessage());
		
		ApiError err = new ApiError(LocalDateTime.now(),HttpStatus.CONFLICT, "Code already exists" ,details);
